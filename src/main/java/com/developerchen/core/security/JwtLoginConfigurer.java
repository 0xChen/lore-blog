...
public final class JwtLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
     ...
     *                  "/login")
     * @return the {@link JwtLoginConfigurer} for additional customization
     */
    @Override
     ...
     * @return the {@link JwtLoginConfigurer} for additional customization
     */
    public JwtLoginConfigurer<H> usernameParameter(String usernameParameter) {
     ...
     * @return the {@link JwtLoginConfigurer} for additional customization
     */
    public JwtLoginConfigurer<H> passwordParameter(String passwordParameter) {
     ...
     * @return the {@link JwtLoginConfigurer} for additional customization
     */
    public JwtLoginConfigurer<H> failureForwardUrl(String forwardUrl) {
     ...
     * @return the {@link JwtLoginConfigurer} for additional customization
     */
    public JwtLoginConfigurer<H> successForwardUrl(String forwardUrl) {
