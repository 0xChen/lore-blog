 ...
 * <p>
 * 接口如：Object getUserById(@Param("id")Long id, @Param("resultType")String resultType);
 * 接口如：Object getUserById(@Param("id")Long id, @Param("resultType")Class resultType);
 * <p>
 * 调用方法参考：City city = (City) mapper.getUserById(1L, City.class);
 * <p>
...
public class MyBatisResultTypeInterceptor implements Interceptor {
    ...
    private Class<?> getResultType(Object parameterObject) {
        if (parameterObject == null) {
            ...
            if (metaObject.hasGetter(resultType)) {
