package com.developerchen.core.system.extension;

import com.developerchen.core.system.config.SystemConfig;
import com.developerchen.core.common.util.CommonUtils;
...
public class DecryptJdbcPassword implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {
    ...
    public static String JDBC_SECRET_KEY_PATH_KEY = "lore.system.jdbc-secret-key-path";
    public static String DEFAULT_JDBC_SECRET_KEY_PATH = SystemConfig.HOME_PATH + File.separator + "jdbcSecretKey";
