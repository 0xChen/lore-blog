...
import com.developerchen.core.system.repository.OptionMapper;
...
public class OptionServiceImpl extends BaseServiceImpl<OptionMapper, Option> implements IOptionService {
    ...
    @Override
    @Transactional(rollbackFor = {Exception.class, Error.class})
    public void upsertOptions(Map<String, String> parameterMap) {
    ...
    private void updateAppConfigOptions() {
        SystemConfig.updateOptions(getAllOption());
    }
