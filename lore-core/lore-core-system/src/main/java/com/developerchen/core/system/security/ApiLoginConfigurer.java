...
public final class ApiLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
        AbstractAuthenticationFilterConfigurer<H, ApiLoginConfigurer<H>, ApiAuthenticationFilter> {

    /**
     * Creates a new instance
     */
    public ApiLoginConfigurer() {
        super(new ApiAuthenticationFilter(), null);
     ...
     *        &lt;/p&gt;
     *        &lt;div&gt;
     *            &lt;button type="submit" class="btn"&gt;OperationLog in&lt;/button&gt;
     *        &lt;/div&gt;
     *    &lt;/fieldset&gt;
     * &lt;/form&gt;
     * </pre>
     ...
     *                  "/login")
     * @return the {@link ApiLoginConfigurer} for additional customization
     */
    @Override
    public ApiLoginConfigurer<H> loginPage(String loginPage) {
     ...
     * @return the {@link ApiLoginConfigurer} for additional customization
     */
    public ApiLoginConfigurer<H> usernameParameter(String usernameParameter) {
     ...
     * @return the {@link ApiLoginConfigurer} for additional customization
     */
    public ApiLoginConfigurer<H> passwordParameter(String passwordParameter) {
     ...
     * @return the {@link ApiLoginConfigurer} for additional customization
     */
    public ApiLoginConfigurer<H> failureForwardUrl(String forwardUrl) {
     ...
     * @return the {@link ApiLoginConfigurer} for additional customization
     */
    public ApiLoginConfigurer<H> successForwardUrl(String forwardUrl) {
