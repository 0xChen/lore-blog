...
/**
 * Processes an HTTP request's JWT authorization headers, putting the result into the
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        UserAuthenticationToken authentication = new UserAuthenticationToken(userDetails, null, userDetails.getAuthorities());
        authentication.setDetails(this.authenticationDetailsSource.buildDetails(request));
        SecurityContextHolder.getContext().setAuthentication(authentication);
        Long userId = ((ApiUser) userDetails).getId();
