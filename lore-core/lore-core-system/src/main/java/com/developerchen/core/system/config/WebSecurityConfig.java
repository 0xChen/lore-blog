...
import com.developerchen.core.system.security.ApiAuthenticationFailureHandler;
import com.developerchen.core.system.security.ApiAuthenticationSuccessHandler;
import com.developerchen.core.system.security.ApiLoginConfigurer;
import com.developerchen.core.system.security.JwtAuthorizationFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorize) -> authorize
                .requestMatchers(new RequestHeaderRequestMatcher("X-Requested-With", ""))
        );
        ...
        http.cors(withDefaults())
                ...
                .formLogin(form -> form
                        ...
                        .permitAll())
                .with(new ApiLoginConfigurer<>(), (loginConfigurer) -> {
