 ...
 * @author syc
 */
@ConfigurationProperties(prefix = "lore.system")
public class SystemProperties {
     ...
     * 目录下查找文件名为 "jwtSecretKey" 的文件. 如果仍然获取不到, 则使用 jwtSecretKey 变量设置的密钥.
     * 文件内容应为256 bits (32 bytes)长度的文本. 例: WoQu@*Nian~Mai-Le%#GeDa^Jin#Biao
     */
    private String jwtSecretKeyPath;

    /**
     * 用于加密解密JWT token的密钥. 内容应为256 bits (32 bytes)长度的文本. 例: WoQu@*Nian~Mai-Le%#GeDa^Jin#Biao
     */
