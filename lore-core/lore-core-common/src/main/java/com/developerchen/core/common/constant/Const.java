package com.developerchen.core.common.constant;
...
public final class Const {
    ...
    /**
     * 应用安装后生成的文件, 通过判断这个文件是否存在可以识别应用安装状态
     */
    public static final File INSTALLED = new File(new ApplicationHome().getDir().getPath()
    ...
    public static final String LOG_WARN = "warn";// 警告日志
    public static final String LOG_ERROR = "error";// 异常日志
