...
public class CommentServiceImpl extends BaseServiceImpl<CommentMapper, Comment> implements ICommentService {
    ...
    public void replyComment(Comment comment) {
        ...
        eventPublisher.publishEvent(new EntityCreatedEvent<>(comment));
    }
    ...
    public void deleteCommentById(long commentId) {
        ...
        if (comment != null) {
            ...
            eventPublisher.publishEvent(new EntityDeletedEvent<>(comment));
        } else {
    ...
    public void deleteCommentByIds(Set<Long> commentIds) {
        ...
        if (!commentList.isEmpty()) {
            ...
            eventPublisher.publishEvent(new EntityDeletedEvent<>(commentList));
        }
    }
