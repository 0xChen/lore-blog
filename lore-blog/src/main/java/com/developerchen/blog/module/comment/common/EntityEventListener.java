...
public class EntityEventListener {
     ...
     */
    @EventListener
    public void deleteComment(EntityDeletedEvent<Post> event) {
     ...
     */
    @EventListener
    public void increasePostCommentCount(EntityCreatedEvent<Comment> event) {
     ...
     */
    @EventListener
    public void updatePostCommentCount(EntityDeletedEvent<Comment> event) {
        Comment comment = event.getSource();
        Long postId = comment.getOwnerId();
        if (postId != null) {
