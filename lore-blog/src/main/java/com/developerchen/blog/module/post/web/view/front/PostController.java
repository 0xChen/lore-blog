package com.developerchen.blog.module.post.web.view.front;
...
public class PostController extends BaseController {
     ...
     * @param cp       当前文章评论的页码
     */
    @GetMapping("/posts/{idOrSlug}/detail")
     ...
     */
    @GetMapping("/pages/{id:\\d{19}}/detail")
     ...
     * 分页形式指定分类下的所有文章
     */
    @GetMapping("/posts/category/{categoryId}/page")
     ...
     * 分页形式指定标签下的所有文章
     */
    @GetMapping("/posts/tag/{tagName}/page")
