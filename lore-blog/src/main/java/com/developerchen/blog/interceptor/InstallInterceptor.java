...
public final class InstallInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        String staticUriPrefix = SystemConfig.staticPathPattern.substring(0,
                SystemConfig.staticPathPattern.lastIndexOf("/"));
        ...
        if (RequestUtils.isApiRequest(request)) {
            String installUrl = SystemConfig.scheme + "://" + SystemConfig.hostname + BlogConst.INSTALL_URI;
